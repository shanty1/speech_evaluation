...
from model import EncoderRNN, DecoderRNN, DecoderRNN_LSTMCell, DecoderRNN_SAME_INPUT
...
def main(args):
    ...
    decoder = DecoderRNN_SAME_INPUT(args.embed_size + Z_DIM, args.hidden_size, len(vocab), vocab('<pad>'), args.num_layers).to(
        device)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--encoder_path', type=str, default='./models/train-same-input-encoder-100-270.ckpt', help='path for trained encoder')
    parser.add_argument('--decoder_path', type=str, default='./models/train-same-input-decoder-100-270.ckpt', help='path for trained decoder')
