...
class EncoderRNN(BaseRNN):
    ...
    def __init__(self, max_len, input_size, hidden_size,vocab_size=None,
    ...
    def forward(self, input_var, input_lengths=None):
        ...
        if self.variable_lengths:
            embedded = nn.utils.rnn.pack_padded_sequence(input_var, input_lengths, batch_first=True, enforce_sorted=False)
